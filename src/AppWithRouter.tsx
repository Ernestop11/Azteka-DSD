...
import {
  ...
  TrendingUp, Users, Truck, Award, Grid3x3, Menu, X, Image, TrendingDown, Database
} from 'lucide-react';
...
function AdminDashboard() {
  ...
  const adminFeatures = [
    ...
    {
      title: 'AI PO Suggestions',
      description: 'Automated purchase order recommendations',
      icon: TrendingDown,
      color: 'from-cyan-500 to-blue-500',
      path: '/admin/po-suggestions',
      badge: 'AI'
    },
    {
      title: 'QuickBooks Sync',
      description: 'Sync inventory and customers from QuickBooks',
      icon: Database,
    ...
    {
      title: 'Integrations',
      description: 'Connect AI services and design tools',
      icon: Settings,
    ...
    <LanguageProvider>
      <AuthProvider>
        <BrowserRouter>
          ...
          <Route path="/admin/po-suggestions" element={<POSuggestions />} />
          <Route path="/admin/quickbooks" element={<QuickBooksSync />} />
